...
def throttle_wait(func=None, throttle=True, max_wait=120):
    """
    ...
    The max_wait argument is the total time since the first request was made
    that the client will make attempts to receive a non-throttled response.
